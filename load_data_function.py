from Data_processesing_class import AudioSpeechNoise_data_load, fNIRS_EEG_HC_baseline_data_load, fNIRS_full_motor_data_load, fNIRS_motor_data_load, fNIRS_Alexandros_DoC_data_load
from Data_processesing_class import fNIRS_Alexandros_Healthy_data_load, fNIRS_CUH_patient_data_load, fNIRS_Melika_tongue_5Hz_data_load
from Data_processesing_class import fNIRS_Melika_hand_data_5Hz_load, fNIRS_Melika_old_data_load, fNIRS_Melika_hand_data_10Hz_load
from Data_processesing_class import fNIRS_Melika_tongue_10Hz_data_load, fNIRS_Melika_hand_data_long_load, fNIRS_Melika_tongue_long_data_load
from Data_processesing_class import fNIRS_Pardis_DOC_data_load, fNIRS_Pardis_HC_data_load
from Data_processesing_class import fNIRS_EEG_HC_baseline_data_load, fNIRS_EEG_HC_follow_up_data_load, fNIRS_EEG_patient_baseline_data_load, fNIRS_EEG_patient_follow_up_data_load
