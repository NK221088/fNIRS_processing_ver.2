...
if study == 1:
    ...
    all_n_back_ = ["single", "Math", "Hard_Math", "Control"]
...
for n_back_ in all_n_back_:
    ...
    if study == 1:
        ...
        if n_back_ == "single":
            ...
            n_backs = ['Covert/Arithmetic/Math', 'Non-Covert/Arithmetic/Math']
        elif n_back_ == "Hard_Math":
            n_backs = ['Covert/Arithmetic/Hard_Math', 'Non-Covert/Arithmetic/Hard_Math']
        control_time = 20.005
        tmax = 24.9
